[![build](https://github.com/opspec-pkgs/azure.vm.create/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/azure.vm.create/actions/workflows/build.yml)
